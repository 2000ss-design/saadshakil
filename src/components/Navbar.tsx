  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'glass-strong py-3' : 'py-5'}`}>
      <div className="container mx-auto flex items-center justify-between px-4">
        <a href="#" className="text-xl font-bold gradient-text relative group">
          {'<SS />'}
      ...
      {menuOpen && (
        <div className="md:hidden glass-strong mt-2 mx-4 rounded-lg p-4 space-y-1 animate-fade-in-up">
          {navLinks.map(l => (
